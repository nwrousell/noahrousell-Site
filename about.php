<div id="about" class="frame-full hide">
    <div class="outside-container">
        <div class="container">
            <h1 class="regular-text lg-text">About</h1>
            <hr class="about-divider">

            <div class="bio-container">
                <p>I taught myself my first programming language, Java, when I was 9 by watching Youtube videos. I haven’t stopped coding since.</p><p>I’ve made <a href="#" class="to-projects projects-link text-half-bg">websites</a> for local businesses, <a href="#" class="to-projects projects-link text-half-bg">a few small apps</a> to scratch an itch, and recently tried out <a href="#" class="to-projects projects-link text-half-bg">game dev</a>. </p>
            </div>
...
"</p>
    ...
    <div class = "arrow-left-container bottom-left">
        <i class="to-home material-icons highlight-text large pointer-on-hover">keyboard_arrow_left</i>
    </div>
    <div class = "arrow-right-container bottom-right">
        <i class="to-projects material-icons highlight-text large pointer-on-hover">keyboard_arrow_right</i>
    </div>
</div>
